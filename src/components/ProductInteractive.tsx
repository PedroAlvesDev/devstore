...
//     return (
//         <div className="group relative z-0 col-span-3 row-span-3 rounded-lg bg-zinc-900 flex justify-center items-center">
//             <Image
...
//                 className="group-hover:scale-105 transition transform duration-500 absolute z-10"
//             />
//             <ButtonAdd onClick={handleAddToCart}
//                 className="relative -bottom-32 left-10 z-20">
